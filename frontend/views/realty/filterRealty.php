...
<div class="section grey lighten-3">
    <div class="container">
        <?php $filter = ActiveForm::begin(['options' => ['data-pjax' => true, 'class' => 'filter filter-main', 'id' => 'filter']]) ?>
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="input-field col s6 no-padding-left">
                                <?= $filter->field($searchModel, 'priceFrom')
                                           ->input('number', ['id' => "filter-price-min", 'placeholder' => "min"])
                                           ->label(false) ?>
                            </div>
                            <div class="input-field col s6 no-padding-right">
                                <?= $filter->field($searchModel, 'priceTo')
                                           ->input('number', ['id' => "filter-price-max", 'placeholder' => "max"])
                                           ->label(false) ?>
                            </div>
                        </div>
                    </div><!--Price-->
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="input-field col s6 no-padding-left">
                                <?= $filter->field($searchModel, 'areaFrom')
                                           ->input('number', ['id' => "filter-area-min", 'placeholder' => "min"])
                                           ->label(false) ?>
                            </div>
                            <div class="input-field col s6 no-padding-right">
                                <?= $filter->field($searchModel, 'areaTo')
                                           ->input('number', ['id' => "filter-area-max", 'placeholder' => "max"])
                                           ->label(false) ?>                                </div>
                        </div>
                    </div>
                </div>
