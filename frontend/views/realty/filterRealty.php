    ...
    <div class="container">
        ...
        <div class="row no-margin">
            ...
            <div class="col s12 m10 l10">
                <div class="row no-margin-bottom">
                        ...
                        <div class="col s12 m8 l8">
                            <div class="row no-margin-bottom">
                                <div class="input-field col s12 m4 l4">
                                    <label class="label"
                                           for="filter-realty-type"><?= Yii::t('app', 'Property Type') ?></label>
                                ...
                                <div class="input-field col s12 m4 l4">
                                    <label class="label"
                                           for="filter-realty-type"><?= Yii::t('app', 'Building Type') ?></label>
                    ...
                    <?php else: ?>
                        <?= Html::activeHiddenInput($searchModel, 'property_type_id') ?><!--Hidden property_type_id-->
                        <div class="input-field col s12 m4 l4">
                            <label class="label" for="filter-realty-type"><?= Yii::t('app', 'Building Type') ?></label>
                            <?= $filter->field($searchModel, 'building_type_id')
                                ->dropDownList($buildingType, ['prompt' => Yii::t('info', 'Select building type'),
                                    'id' => "filter-realty-type"])
                                ->label(false) ?>
                        </div><!--Building Type-->
                        <div class="input-field col s12 m4 l4">
                            <label class="label" for="filter-ad-type"><?= Yii::t('app', 'Ad Type') ?></label>
                            <?= $filter->field($searchModel, 'ad_type_id')
                                ->dropDownList($advertingType, ['prompt' => Yii::t('info', 'Select adverting type'),
                                    'id' => "filter-ad-type"])
                                ->label(false) ?>
                        </div><!--Ad Type-->
                    <?php endif; ?>
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="input-field col s6 no-padding-left">
                                <?= $filter->field($searchModel, 'areaFrom')
                                    ->input('number', ['id' => "filter-area-min",
                                        'placeholder' => "min"])
                                    ->label(false) ?>
                            </div>
                            <div class="input-field col s6 no-padding-right">
                                <?= $filter->field($searchModel, 'areaTo')
                                    ->input('number', ['id' => "filter-area-max",
                                        'placeholder' => "max"])
                                    ->label(false) ?>                                </div>
                        </div>
                    </div>
        ...
        <div id="modal-detail-location" class="modal">
            <div class="modal-content">
                ...
                <div class="input-field">
                    ...
                    <?= $filter->field($searchModel, 'country_id')
                        ->dropDownList($country, ['prompt' => Yii::t('info', 'Select country'),
                            'id' => 'filter-country'])
                        ->label(false) ?>
                </div>
                <div class="input-field">
                    ...
                    <?= $filter->field($searchModel, 'postalCode')
                        ->textInput(['id' => 'filter-postal-code',
                            'placeholder' => '102541'])
                        ->label(false) ?>
                </div>
                <div class="input-field">
                    ...
                    <?= $filter->field($searchModel, 'region')
                        ->dropDownList($region, ['prompt' => Yii::t('info', 'Select a region'),
                            'id' => 'filter-region',
                            'disabled' => true])
                        ->label(false) ?>
                </div>
            ...
            <div class="modal-footer">
                <a href="#!"
                   class=" modal-action modal-close waves-effect waves-green btn-flat"><?= Yii::t('app', 'Apply') ?></a>
            </div>
        </div>
        <!-- modals end-->
        <?php ActiveForm::end() ?>
